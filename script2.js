document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        { question: "旅行的前一晚，你攤開地圖與記事本，腦海裡浮現這趟冒險的樣子。在眾多可能性中，你最想先準備的是？", image: "images/q1.png", options: [ { text: "A. 把行程表排得清清楚楚，每一步都要安排得妥當。", scores: [{ability: "執行力", value: 1}, {ability: "沉著性", value: 1}] }, { text: "B. 整理一份必吃清單，想到美食就充滿期待。", scores: [{ability: "行動力", value: 1}, {ability: "探索力", value: 1}] }, { text: "C. 想像會遇到什麼有趣的人，期待新的相遇。", scores: [{ability: "守護力", value: 1}, {ability: "故事力", value: 1}] } ] },
        { question: "打開行李箱，準備把必需品放進去。有一樣東西，是你再忙也不會忘記帶上的：", image: "images/q2.png", options: [ { text: "A. 相機或筆記本，用來捕捉細節與靈感。", scores: [{ability: "靈感力", value: 1}, {ability: "創造力", value: 1}] }, { text: "B. 零食與水，補足能量走得更遠。", scores: [{ability: "可靠度", value: 1}, {ability: "安定感", value: 1}] }, { text: "C. 小禮物或伴手禮，準備在旅途中送給新朋友。", scores: [{ability: "療癒力", value: 1}, {ability: "探索力", value: 2}] } ] },
        { question: "清晨的空氣撲面而來，旅行正式開始。此刻，你心裡最接近的感受是？", image: "images/q3.png", options: [ { text: "A. 心跳加快，恨不得馬上衝出去探索。", scores: [{ability: "行動力", value: 1}, {ability: "社交力", value: 1}] }, { text: "B. 平穩安定，默默觀察，隨遇而安。", scores: [{ability: "沉著性", value: 2}, {ability: "守護力", value: 1}] }, { text: "C. 想著要把沿途的故事風景，要和誰一起分享才更有意思。", scores: [{ability: "故事力", value: 1}, {ability: "創造力", value: 1}] } ] },
        { question: "經過一段漫長的車程，你終於抵達這座小鎮。推著行李走出車站，眼前是蜿蜒的街道，攤販叫賣聲、人群交談聲熱鬧不絕。此刻，你腦海中第一個念頭是？", image: "images/q4.png", options: [ { text: "A. 哪裡有吃的！我先去填飽肚子。", scores: [{ability: "探索力", value: 1}, {ability: "行動力", value: 1}] }, { text: "B. 慢慢走，邊觀察街景和人群。", scores: [{ability: "專注力", value: 1}, {ability: "洞察力", value: 1}] }, { text: "C. 找個路人聊聊，問問這裡有什麼必去的地方。", scores: [{ability: "細心度", value: 1}, {ability: "故事力", value: 1}] } ] },
        { question: "你拖著行李走過石板路，小鎮的氣味與聲音逐漸圍繞著你。忽然，你停下腳步，因為眼前有個畫面深深吸引了你——", image: "images/q5.png", options: [ { text: "A. 香氣四溢的攤位，熱氣撲面讓人食指大動。", scores: [{ability: "行動力", value: 1}, {ability: "探索力", value: 1}] }, { text: "B. 老屋牆面上的斑駁痕跡，像在低語著時間的故事。", scores: [{ability: "執行力", value: 1}, {ability: "靈感力", value: 1}] }, { text: "C. 人群的笑聲和交談，氛圍讓你忍不住微笑。", scores: [{ability: "療癒力", value: 1}, {ability: "社交力", value: 1}] } ] },
        { question: "走著走著，你被一扇半掩的木門吸引，推開門後走進一間小店。裡頭陳列著舊書、木椅與茶具，空氣裡瀰漫著木頭和淡淡茶香。這一刻，你會先做什麼？", image: "images/q6.png", options: [ { text: "A. 馬上問老闆：這裡有什麼故事或特色？", scores: [{ability: "故事力", value: 1}, {ability: "社交力", value: 1}] }, { text: "B. 彎下身仔細觀察桌椅與工藝品，不想錯過任何細節。", scores: [{ability: "專注力", value: 1}, {ability: "創造力", value: 1}] }, { text: "C. 發現有件陳列的小物掉落，你順手將它放回原位。", scores: [{ability: "細心度", value: 2}, {ability: "可靠度", value: 1}] } ] },
        { question: "離開特色小店，你走到小鎮廣場，一群背著背包的旅人正圍在地圖前爭論著方向。你停下腳步，心裡盤算著要不要加入他們", image: "images/q7.png", options: [ { text: "A. 立刻上前，自然地和大家聊起來，順勢加入行程。", scores: [{ability: "社交力", value: 2}, {ability: "行動力", value: 1}] }, { text: "B. 在一旁觀察，看看他們的互動與氣氛，再決定是否參與。", scores: [{ability: "沉著性", value: 1}, {ability: "洞察力", value: 1}] }, { text: "C. 提出一個有趣的點子，讓氣氛更輕鬆活絡。", scores: [{ability: "靈感力", value: 1}, {ability: "創造力", value: 1}] } ] },
        { question: "後來你和旅人們一路逛到市集，攤位一個接一個，氣味與聲音熱鬧交織。就在這裡，你不自覺停下了腳步。", image: "images/q8.png", options: [ { text: "A. 被食物攤位的香氣吸引，想立刻嚐一口。", scores: [{ability: "行動力", value: 1}, {ability: "探索力", value: 1}] }, { text: "B. 注視著工藝攤上的手作小物，細細端詳其中的巧思。", scores: [{ability: "執行力", value: 1}, {ability: "專注力", value: 1}] }, { text: "C. 停在一個有人講故事的角落，聽著人群笑聲聚集。", scores: [{ability: "守護力", value: 1}, {ability: "故事力", value: 1}] } ] },
        { question: "在市集的角落，你和一位當地人聊了起來。閒聊中，他笑著問你：「到目前為止，這趟旅程你最喜歡的是什麼？」", image: "images/q9.png", options: [ { text: "A. 玩得盡興、吃到開心，留下最直接的快樂。", scores: [{ability: "行動力", value: 1}, {ability: "探索力", value: 1}] }, { text: "B. 認識新朋友，留下溫暖的人際回憶。", scores: [{ability: "療癒力", value: 1}, {ability: "社交力", value: 1}] }, { text: "C. 發現隱藏在巷弄裡的細節與故事。", scores: [{ability: "洞察力", value: 2}, {ability: "專注力", value: 1}] } ] },
        { question: "聊著聊著，天空突然烏雲密布，沒多久便下起了大雨。人群一陣騷動，你抬頭看著雨滴落在柏油路上，心裡浮現一個念頭。", image: "images/q10.png", options: [ { text: "A. 幫忙攤位的老闆收拾容易被淋濕的東西。", scores: [{ability: "守護力", value: 1},{ability: "可靠度", value: 1}] }, { text: "B. 不慌不忙地撐開雨傘，邊走邊欣賞小鎮在雨中的樣貌。", scores: [{ability: "洞察力", value: 1}, {ability: "沉著性", value: 1}] }, { text: "C. 靈機一動，提醒大家把攤位的布簾放下來，瞬間就多了好幾個避雨的角落。", scores: [{ability: "創造力", value: 1}, {ability: "執行力", value: 1}] } ] },
        { question: "雨勢漸漸停了下來，街道還殘留著水窪與潮濕的氣息。你走進一條小巷，看見一位旅人正四處張望，臉上帶著迷茫。他抬頭看向你，彷彿在尋求幫助。", image: "images/q11.png", options: [ { text: "A. 主動走上前，帶他到主要街道，確認他能找到方向。", scores: [{ability: "可靠度", value: 1}, {ability: "執行力", value: 1}] }, { text: "B. 陪他慢慢走，邊閒聊邊幫他放鬆心情，一起找到出口。", scores: [{ability: "療癒力", value: 1}, {ability: "守護力", value: 1}] }, { text: "C. 拿出筆和紙，畫一張簡單的地圖，或在牆邊做個小記號。", scores: [{ability: "執行力", value: 1}, {ability: "靈感力", value: 1}] } ] },
        { question: "天色漸暗，街燈一盞盞亮起，你開始尋找今晚的落腳處，你會選擇：", image: "images/q12.png", options: [ { text: "A. 熱鬧的旅館，大廳人聲鼎沸，像小鎮的另一個縮影。", scores: [{ability: "社交力", value: 1}, {ability: "探索力", value: 1}] }, { text: "B. 靠近巷弄深處的民宿，安靜整潔，讓人能好好沉澱。", scores: [{ability: "安定感", value: 2}, {ability: "沉著性", value: 1}] }, { text: "C. 一間帶有特色裝飾的小旅店，櫥窗透出溫暖的光芒。", scores: [{ability: "靈感力", value: 1}, {ability: "專注力", value: 1}] } ] },
        { question: "安置好行李後，住宿老闆熱情地招呼你：「今晚有個小活動，要不要一起來？」你猶豫片刻，最後決定?", image: "images/q13.png", options: [ { text: "A. 上台參加比賽或表演，親身體驗鎮上的熱鬧", scores: [{ability: "探索力", value: 1},{ability: "社交力", value: 1}] }, { text: "B. 坐在人群中，和左右的人閒聊，結識幾位新朋友。", scores: [{ability: "守護力", value: 1}, {ability: "社交力", value: 1}] }, { text: "C. 默默幫忙老闆，確保活動順利進行。", scores: [{ability: "可靠度", value: 2}, {ability: "執行力", value: 1}] } ] },
        { question: "第二天清晨，你準備啟程離開，一邊想著要怎麼把這趟旅程留在記憶裡，或帶給別人一些痕跡。", image: "images/q14.png", options: [ { text: "A. 買一份當地特產或伴手禮，帶回去和朋友分享。", scores: [{ability: "行動力", value: 1}, {ability: "療癒力", value: 1}] }, { text: "B. 用照片或文字，把這段旅程的風景與心情記錄下來。", scores: [{ability: "故事力", value: 1}, {ability: "洞察力", value: 1}] }, { text: "C. 選一件手作工藝品，或寫一張明信片，作為獨特的紀念。", scores: [{ability: "創造力", value: 1}, {ability: "細心度", value: 1}] } ] },
        { question: "當火車緩緩駛離，回想這趟旅程，心裡浮現一個最深的體會是：", image: "images/q15.png", options: [ { text: "A. 勇敢行動，總能遇見意想不到的驚喜。", scores: [{ability: "行動力", value: 1}, {ability: "探索力", value: 1}] }, { text: "B. 陪伴與照顧，讓每一段旅程都更溫暖。", scores: [{ability: "療癒力", value: 1}, {ability: "安定感", value: 2}] }, { text: "C. 細心觀察，才能創造出新的價值與故事。", scores: [{ability: "專注力", value: 1}, {ability: "洞察力", value: 1}] } ] },
    ];
