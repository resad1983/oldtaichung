document.addEventListener('DOMContentLoaded', () => {
    ...
    const results = {
        "醋咪": { title: "熱情的城市嚮導", image: "images/醋咪.png", description: "你是用「味蕾」探索世界的人，總是聞到香氣就迫不及待前往。你的 食慾值 讓你敢於嘗試新事物，分享力 讓你樂於與朋友分享美食與樂趣，靈活度 讓你在街頭巷尾穿梭自如。", revelation: "你的存在能讓身邊的人不再錯過任何美好事物。請記得，偶爾慢下腳步，享受食物背後的故事與人情味。" },
        "Bu-Bu": { title: "溫柔的縫補者", image: "images/Bu-Bu.png", description: "你細心、溫柔，總能注意到別人忽略的細節。你的 縫補力 讓你能修復、療癒，細膩度 讓你懂得觀察人心，創意感 讓你能把碎片拼湊成新風格。", revelation: "你帶給世界的是安心與美感。請相信自己的細膩不是弱點，而是一種能連結人心的力量。" },
        "匠郎": { title: "專注的工藝職人", image: "images/匠郎.png", description: "你追求品質與美感，喜歡親手創造並欣賞細節。你的 工藝力 讓你能專心打造作品，配色感 讓你在混亂中找到秩序，專注度 讓你持續完成長遠的目標。", revelation: "你的堅持讓世界看見美的可能。別忘了，作品之外，你的人生也需要留白與呼吸。" },
        "銅仔": { title: "沉穩的守信者", image: "images/銅仔.png", description: "你重視承諾與規則，做事有條不紊。你的 守信力 讓人依賴，數字感 讓你在複雜情境中保持冷靜，沉穩度 讓你成為團隊的靠山。", revelation: "你是別人眼中的「安全感」。但也別把自己困在框架裡，偶爾允許自己嘗試一些冒險。" },
        "旺望": { title: "念舊的記錄者", image: "images/旺望.png", description: "你對過去充滿情感，喜歡透過物品與故事回憶時光。你的記憶力讓你記住細節，洞察力讓你理解事物背後的意義，耐心值讓你能靜靜等待、慢慢品味。", revelation: "你是時光的守護者。透過你的眼睛，大家能看見被遺忘的美好。記得，創造新的回憶和保存舊的一樣重要。" }
    };
