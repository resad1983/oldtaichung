document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        ...
        { question: "旅伴臨時有狀況，需要調整行程，你會？", image: "images/q8.png", options: [ { text: "A. 沒關係，剛好去探索新地方", scores: [{ability: "靈活度", value: 1}, {ability: "耐心值", value: 0.5}] }, { text: "B. 先關心對方狀況，行程之後再說", scores: [{ability: "縫補力", value: 1.5}, {ability: "守信力", value: 0.5}] }, { text: "C. 馬上拿出備案，重新規劃路線", scores: [{ability: "沉穩度", value: 1}, {ability: "配色感", value: 0.5}] } ] },
